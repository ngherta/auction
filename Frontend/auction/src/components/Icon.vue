<template>
  ...
  <svg v-else-if="name === 'profile-images'" :width="20 * this.sizePercent" :height="20 * this.sizePercent" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
...
<g>
  ...
  <svg v-else-if="name === 'profile-complaints'" :width="20 * this.sizePercent" :height="20 * this.sizePercent"  id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
